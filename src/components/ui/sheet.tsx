    ...
    return (
        <SheetPortal>
            ...
            <SheetPrimitive.Content
                ...
                className={cn(
                    "fixed z-50 flex flex-col gap-4 shadow-lg transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-300 data-[state=open]:animate-in data-[state=closed]:animate-out",
                    side === "right" &&
                    ...
                    "border-white/10 bg-[#0A0A14]/95 backdrop-blur-xl p-6",
                    className
                )}
                {...props}
            >
